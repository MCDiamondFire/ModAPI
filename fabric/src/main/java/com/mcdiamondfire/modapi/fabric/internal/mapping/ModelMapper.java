...
import com.mcdiamondfire.modapi.fabric.model.player.PlayerPermissions;
import com.mcdiamondfire.modapi.fabric.model.player.PlayerPermissions.Rank;
...
public final class ModelMapper {
	...
	private static PlayerPermissions permissions(
		...
		addRank(ranks, permissions.getVip(), Rank.VIP);
		addRank(ranks, permissions.getQa(), Rank.TESTER);
		addRank(ranks, permissions.getYoutuber(), Rank.YOUTUBER);
		...
		return new PlayerPermissions(ranks.toArray(Rank[]::new));
	}
