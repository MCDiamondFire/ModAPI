 ...
 * @param owner       whether the connected player owns the plot
 * @param developer   whether the connected player may edit the plot's code
 * @param builder     whether the connected player may build on the plot
